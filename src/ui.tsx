...
function Plugin() {
  ...
  return (
    <Container space="large">
      ...
      <VerticalSpace space="small"/>
      <Button
        disabled={!colorVariables || colorVariables === GENERATING_TITLE || colorsCopyButtonText === COPIED_TITLE}
        onClick={copyColors}
      >
      ...
      <VerticalSpace space="small"/>
      <Button
        disabled={!modeVariables || modeVariables === GENERATING_TITLE || modeCopyButtonText === COPIED_TITLE}
      ...
      <VerticalSpace space="small"/>
      <Button
        disabled={!componentVariables ||  componentVariables === GENERATING_TITLE || componentCopyButtonText === COPIED_TITLE}
        onClick={copyTokens}
      >
